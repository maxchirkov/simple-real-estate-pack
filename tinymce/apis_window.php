...
<head>
	<title>Education and Yelp APIs</title>
...
jQuery(document).ready( function() {	
		...
		jQuery('select#location_type').change( function() {
			reset_panels();
		});		
		
		jQuery('.collapsible .section_title').click(function(){
			reset_toggle();
		});
		
		
		jQuery('#listings_latitude').focus(function () {
			var panel = get_current_panel();			
	...
	function insertsimpleAPIsLink() {
		...
		var param = ['location_title', 'city', 'state', 'zip', 'lat', 'lng', 'groupby', 'output'];
	...
	if(jQuery('#simpleAPIs_tab2').attr('class') == 'current'){
	...
	.active {
		background: #A2C5E8 url(../images/plus-minus.gif) 5px 1px no-repeat;
	}
...
<!-- <form onsubmit="insertLink();return false;" action="#"> -->
	...
	<div class="tabs">
		<ul>
			<li id="simpleAPIs_tab1" class="current"><span><a href="javascript:mcTabs.displayTab('simpleAPIs_tab1','simpleAPIs_panel');" onmousedown="tab_click();return false;"><?php _e("Insert Local Schools", 'simpleAPIs'); ?></a></span></li>
			<li id="simpleAPIs_tab2"><span><a href="javascript:mcTabs.displayTab('simpleAPIs_tab2','simpleAPIs_panel2');" onmousedown="tab_click();return false;"><?php _e("Insert Yelp Businesses", 'simpleAPIs'); ?></a></span></li>
		</ul>
	</div>	
	<div id="simpleAPIs_options" class="panel_wrapper" style="height:280px">
		<!-- simpleAPIs panel -->
		<div id="simpleAPIs_panel" class="panel current">
		<br />
		
		<div align="center" style="font-weight: bold; background:#F3F6FB; border: 1px solid #D2DFFF; padding: 3px 0;">School Location by : 
		...
		<table id="bycity" class="bycity" width="320" border="0" cellpadding="4" cellspacing="0">
          ...
          <tr>
            ...
            <td width="190"><input type="text" name="textfield822" class="city"><span>*</span></td>
          </tr>
          <tr>
            <td>State</td>
		...
		<table id="bycoord" class="bycoord" width="320" border="0" cellpadding="4" cellspacing="0">
          ...
          <tr>
            ...
            <td width="190"><input type="text" name="textfield8" class="lat"><span>*</span></td>
          </tr>
		...
		<!-- simpleAPIs panel -->
		<div id="simpleAPIs_panel2" class="panel">
		<br />
		<table width="320" border="0" cellpadding="4" cellspacing="0">
          <tr>
            <td colspan="2"><div align="center"><strong> Nearby Businesses by Yelp </strong></div></td>
          </tr>
          <tr>
            <td width="130"> Latitude </td>
		 ...
		 <div class="optional_params">
			<div class="section_title">Optional Parameters</div>
				<table id="yelp" width="320" border="0" cellpadding="4" cellspacing="0">
				  ...
				  <tr>
					<td>Sort by </td>
					<td><select name="select" class="sortby">
	...
	<div class="mceActionPanel">
		...
		<div style="float: left">
			<input type="button" id="cancel" name="cancel" value="<?php _e("Cancel", 'simpleAPIs'); ?>" onclick="tinyMCEPopup.close();" />
		</div>


		<div style="float: right">
			<input type="submit" id="insert" name="insert" value="<?php _e("Insert", 'simpleAPIs'); ?>" onclick="insertsimpleAPIsLink();" />
		</div>
	</div>
</form>
</body>
