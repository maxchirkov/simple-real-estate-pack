...
(function() {
	...
	tinymce.PluginManager.requireLangPack('srp_APIs');

	tinymce.create('tinymce.plugins.srp_APIs', {
		/**
		...
		init : function(ed, url) {
			...
			// Register srp_APIs button
			ed.addButton('srp_APIs', {
				title : 'Schools and Yelp',
				cmd : 'mcesrp_APIs',
				image : url + '/apis.png'
			});
			// Add a node change handler, selects the button in the UI when a image is selected
			ed.onNodeChange.add(function(ed, cm, n) {
				cm.setActive('srp_APIs', n.nodeName == 'IMG');
			});
		},
		/**
	...
	// Register plugin
	tinymce.PluginManager.add('srp_APIs', tinymce.plugins.srp_APIs);
})();