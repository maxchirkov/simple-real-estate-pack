...
-->
                                ...
                                <tr valign="bottom">
                                    <th scope="row">
                                        <div align="right">Google Maps API Key:</div>
                                    </th>
                                    <td><input type="text" name="srp_gmap[api_key]"
                                               value="<?php echo (isset($srp_gmap['api_key'])) ? $srp_gmap['api_key'] : ''; ?>" size="60"/>
                                        <div class="description"><a href="https://developers.google.com/maps/documentation/javascript/get-api-key" target="_blank">Follow Google's instructions on how to create <strong>Standard API Key</strong>.</a></div>
                                    </td>
                                </tr>

                                <tr valign="bottom">
                                    <th scope="row">
                                        <div align="right">Mapping options from Yelp:</div>
                                    </th>
                                    <td><input type="checkbox"
                                               name="srp_gmap[yelp]" <?php if (isset($srp_gmap['yelp']) && !empty($srp_gmap['yelp']))
                                        {
                                            echo 'checked';
                                        } ?>/>
                                        <a href="<?php echo ADMIN_URL; ?>/admin.php?page=srp_yelp">Yelp
                                            API key</a> is required.
                                        <br/>A box with options like Schools, Grocery Stores,
                                        Hospitals etc. will be added to your Google Maps.
                                    </td>
                                </tr>
						...
						<tr valign="bottom">
						  ...
						  <td>
                                                        <input type="checkbox" name="srp_gmap[search]" <?php if (isset($srp_gmap['search']) && !empty($srp_gmap['search']))
                                {
                                    echo 'checked';
                                } ?>/>
                                                  </td>
...
-->
                                <tr valign="bottom">
                                    <th scope="row">
                                        <div align="right">Main Marker Legend:</div>
                                    </th>
                                    <td><input type="checkbox"
                                               name="srp_gmap[mainmarker]" <?php if (isset($srp_gmap['mainmarker']) && !empty($srp_gmap['mainmarker']))
                                        {
                                            echo 'checked';
                                        } ?>/>
                                ...
                                <tr valign="bottom">
                                    <th scope="row">
                                        <div align="right">Main Marker Label:</div>
                                    </th>
                                    <td><input type="text" name="srp_gmap[mainmarker_label]"
                                               value="<?php echo (isset($srp_gmap['mainmarker_label'])) ? $srp_gmap['mainmarker_label'] : ''; ?>"/>
                                    </td>
                                </tr>
                            ...
                            <p class="submit">
                                <input name="srp_gmap_submit" type="submit" class="button-primary"
